<?php
	...
	if ($usernametoko == "" || $passwordtoko == "" || $nomortelepontoko == "" || $namatoko == "" || $alamattoko == "" || $layanantoko == "" || $deskripsitoko == "" || $jamoperasitoko == "" || $terms != "agree"){
		...
		if (mysqli_num_rows($hasilcek) != 0){
			...
			$insertdata = "INSERT INTO toko (usernametoko, passwordtoko, nomortelepontoko, 	namatoko, alamattoko, layanantoko, deksripsitoko, jamoperasitoko) VALUES ('$usernametoko', MD5('$passwordtoko'), '$nomortelepontoko', '$namatoko', '$alamattoko', '$layanantoko', '$deskripsitoko', '$jamoperasitoko')";
